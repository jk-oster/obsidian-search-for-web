    ...
    <div class="max-w-2xl dark:text-white text-base">
      ...
      <form id="settings" name="settings">
        ...
        <fieldset class="mt-4">
          ...
          <div class="mb-6">
            <label for="darkMode" class="inline-flex relative items-center mr-5 cursor-pointer">
              <input v-model="store.darkMode" type="checkbox" id="darkMode" name="darkMode"
                     class="sr-only peer" :checked="store.darkMode"/>
              <div
