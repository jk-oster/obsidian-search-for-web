    ...
    <nav class="bg-white border-gray-200 px-2 sm:px-4 py-2.5 dark:bg-gray-900">
      <div class="container flex flex-wrap justify-between items-center mx-auto">
        <a href="#" class="flex items-center">
          <img src="/icon/obsidian48.png" class="mr-3 h-6 sm:h-9" alt=""/>
        ...
        <button data-collapse-toggle="navbar-default" type="button"
          ...
          <img class="w-6 h-6" aria-hidden="true" src="/icon/obsidian48.png"/>
        </button>
        ...
        <fieldset class="mt-4">
          ...
          <div class="mb-6">
            <label for="embeddedResults" class="inline-flex relative items-center mr-5 cursor-pointer">
              ...
              <span class="ml-3 text-sm font-medium text-gray-900 dark:text-gray-300">
                  Embed search results on Search-Engines (Google, Bing, DuckDuckGo, Kagi)
              </span>
            </label>
          </div>
